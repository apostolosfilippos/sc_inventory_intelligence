...
![Sales & Delivery Performance](./dashboard/page1_sales_delivery.png)
...
![Product Profitability](./dashboard/page2_product_profitability.png)
...
|------|------|-------------|
| `orders_and_shipments.csv` | 30,871 | Orders with customer, product, shipment, and financial data |
| `inventory.csv` | 4,200 | Monthly warehouse inventory levels and cost per unit |
